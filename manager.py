...
- 第二段：重點新聞
    - 從 STEEP +B 六個主題（社會、科技、經濟、環境、政治、投資）中，針對「每個主題」幫我總結當天該主題的新聞，內容越廣越好，旨在讓讀者快速抓到社會脈動。請不要超過 150 字。
    - 針對各個主題，幫我找出 2 個最有代表性的事件，重新命名你選出來的新聞標題，並且用 100 - 150 字改寫該篇新聞。這邊要比上一段詳細一點，針對單一事件進行分析，但不要超過 150 字。
    - 針對每則你摘出來的新聞，也幫我撰寫為什麼你認為該則新聞具有代表性，用 1~3 句話簡單闡述。
- 第三段：微弱信號
    - 相對於第二部份的重點新聞，某些事件或許沒有這麼重要，但可能是未來趨勢的預兆。這一段請你幫我針對各個主題（社會、科技、經濟、環境、政治、投資）找出兩個這類帶有「微弱信號」的事件，用 100 字簡單改寫該篇新聞。
